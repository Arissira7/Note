# 17面试官：“简历写着用过 Claude Code，那源码看过吗？”，我怼回去：“没看过，又能怎？”

作者: 小林coding
创建时间: May 5, 2026 2:57 PM
原始链接: https://mp.weixin.qq.com/s?__biz=MzUxODAzNDg4NQ==&mid=2247556000&idx=1&sn=01e3a55e22467c677af3e75f9a6d7c62&chksm=f802a9b55a40873f24581dda9123826061730adf7bf0f08fc1df4627e8e3fb357b2f64021c35&mpshare=1&scene=1&srcid=0505fyJaTA0XRVxVaPD9RP9q&sharer_shareinfo=549a0567337d249657509f1ec1681ac9&sharer_shareinfo_first=549a0567337d249657509f1ec1681ac9#rd
平台: 微信
...
![](17%E9%9D%A2%E8%AF%95%E5%AE%98%EF%BC%9A%E2%80%9C%E7%AE%80%E5%8E%86%E5%86%99%E7%9D%80%E7%94%A8%E8%BF%87%20Claude%20Code%EF%BC%8C%E9%82%A3%E6%BA%90%E7%A0%81%E7%9C%8B%E8%BF%87%E5%90%97%EF%BC%9F%E2%80%9D%EF%BC%8C%E6%88%91%E6%80%BC%E5%9B%9E%E5%8E%BB%EF%BC%9A%E2%80%9C%E6%B2%A1%E7%9C%8B%E8%BF%87%EF%BC%8C%E5%8F%88%E8%83%BD%E6%80%8E%EF%BC%9F%E2%80%9D/cover.jpg)
...
```
export const MAX*ENTRYPOINT*LINES = 200
exportconst MAX*ENTRYPOINT*BYTES = 25_000  // 25KB

exportfunction truncateEntrypointContent(raw: string): EntrypointTruncation {
// 同时检查行数和字节数上限
const wasLineTruncated = lineCount > MAX*ENTRYPOINT*LINES
const wasByteTruncated = byteCount > MAX*ENTRYPOINT*BYTES
...
拿到文件名列表后，系统才去读取这几条记忆的完整内容，作为 注入当前对话。
